...
public class Ejercicio5_Bien {
	...
	public static void main(String[] args) {
		...
		// Obtenemos el objeto cliente de la base de datos partiendo del nombre que
		// recibimos por args
		...
		for (Ventas v : clientes.get(0).getVentases()) {
		...
		// Imprimo el "resumen"
		System.out.println("------------------------------------------");
		System.out.printf("Numero total de ventas: %d%n", clientes.get(0).getVentases().size());
